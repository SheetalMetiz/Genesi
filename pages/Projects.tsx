...
import envirenment from '../public/static/images/envirenment.jpg';
import node from '../public/static/images/nodeenicon.png';
import proof from '../public/static/images/prooficon.png';
import cloud from '../public/static/images/cloudicon.png';
        ...
        <div className=" text-white grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-8">
          <div>
            ...
            <p className='text-gray-400'>Proof of stake blockchain validation is more environmentally friendly than proof of work, as it consumes significantly less energy by not requiring computational puzzles to be solved. Validators are selected based on cryptocurrency holdings,
             ...
             <p className='text-gray-400 my-5'>Unless directly disclosed none of the projects we support will operate through Proof of Work.</p>
             <Image className="w-[18px] h-[18px] my-3" src={proof} alt="me" width="64" height="64" />
          </div>
          ...
          <h2 className='text-xl'>CLOUD COMPUTING</h2>
            ...
            <p className='text-gray-400 my-5'>Overall, cloud computing provides an eco-friendly and efficient solution for validating and recording transactions on PoS blockchains.</p>
            <Image className="w-[18px] h-[18px] my-3" src={cloud} alt="me" width="64" height="64" />
          </div>
          ...
          <h2 className='text-xl'>NODE ARMY</h2>
            ...
            <Image className="w-[18px] h-[18px] my-3" src={node} alt="me" width="64" height="64" />
          </div>
        </div>
      </div>
    </div>
